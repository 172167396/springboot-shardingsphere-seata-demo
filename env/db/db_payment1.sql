...
CREATE TABLE `tb_pay_detail0` (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `payment_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- ----------------------------
-- Table structure for tb_pay_detail5
-- ----------------------------
DROP TABLE IF EXISTS `tb_pay_detail5`;
CREATE TABLE `tb_pay_detail5` (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `payment_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `money` decimal(9,2) DEFAULT NULL,
  `count` decimal(9,2) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb3 COMMENT='AT transaction mode undo table';
